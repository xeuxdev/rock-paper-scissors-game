...
const ModalOpen = () => {
  ...
  return (
    <button
      className="absolute bottom-0 left-[60%] md:left-[80%] uppercase w-32 h-11 grid place-items-center  text-Header font-bold border-2 border-Header rounded-lg mb-10 hover:text-white duration-300 hover:border-white z-30 mt-6"
