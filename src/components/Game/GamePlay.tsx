...
const GamePlay = () => {
  const selectedChoice = useContext(GameContext)
  const player = selectedChoice?.playerChoice
  const AI = selectedChoice?.aiChoice
    ...
    <div className="w-full md:max-w-[31.25rem] h-[18.75rem] md:h-[28.125rem] mx-auto relative">
      <div className="flex flex-wrap justify-between">
        <div className="flex flex-col md:flex-col-reverse items-center">
          <div
            className={`w-[8.75rem] h-[8.75rem] md:w-[12.5rem] md:h-[12.5rem] rounded-full bg-${player}_gradient_2 relative grid place-items-center border-b-[10px] border-b-${player}_gradient_1 shadow-lg hover:cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-${player}_gradient_1`}
